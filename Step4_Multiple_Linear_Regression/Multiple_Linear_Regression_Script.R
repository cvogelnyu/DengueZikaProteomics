...
#read in table with gene names: pdata3_gene_names.xlsx
#set first column as rownames
pdata3_gene_names <- data.frame(pdata3_gene_names, row.names = 1)
...
write.table(pdata4, "pdata4.txt", sep="\t", quote=F)
#read in table with gene names: pdata4_gene_names.xlsx
#set first column as rownames
pdata4_gene_names <- data.frame(pdata4_gene_names, row.names = 1)
