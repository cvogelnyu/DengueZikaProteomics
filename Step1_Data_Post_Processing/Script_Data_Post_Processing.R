# Input file Zika_Dengue_reduced.txt; generated by using Spectronaut BGS_Report output file; making a unique identifier to get a single value for a fragment in a peptide, and sorting the data in decreasing order of fragment ion peak areas (column: F.NormalizedPeakArea)

# Due to file size (>500MB) Zika_Dengue_reduced.txt cannot be provided on github. We will provide merged_table_input.txt instead (see line 59)
...
write.table(dat, "merged_table_input.txt", sep="\t", quote=F, row.names=F, na="")
